...
namespace CODEFIRST_JD_FM.Migrations
{
    ...
    [Migration("20240304163217_fourth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.Customers", b =>
                {
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.Orders", b =>
                {
                    b.Property<int>("orderNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT(11)");
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.Payments", b =>
                {
                    b.Property<int>("customerNumber")
                        .HasColumnType("INT(11)");
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.Customers", b =>
                {
                    b.HasOne("CODEFIRST_JD_FM.MODEL.Employees", "Employees")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.OrderDetails", b =>
                {
                    b.HasOne("CODEFIRST_JD_FM.MODEL.Orders", "Orders")
                        .WithMany("OrderDetails")
                        .HasForeignKey("orderNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CODEFIRST_JD_FM.MODEL.Products", "Products")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("CODEFIRST_JD_FM.MODEL.Orders", b =>
                {
                    b.HasOne("CODEFIRST_JD_FM.MODEL.Customers", "Customers")
                        .WithMany("Orders")
